...
| Sheet Authoring Guide | `Core/Document/SheetAuthoringGuide.md` | Details for Table vs. Const layouts and sample workflows. |
| Google OAuth Guide | `Core/Document/GoogleOAuthSetup.md` | Steps for creating/storing `client_secret.json` and tokens. |
...
- Add future documentation under `Document/` (Unity-specific) or `Core/Document/` (engine-agnostic) and link it from `README.md` as needed.
