...
3. Ensure `client_secret.json` points to your local OAuth credentials (see `Document/GoogleOAuthSetup.md`).
...
## What to expect
- Row definitions follow the “table” guide from `Document/SheetAuthoringGuide.md`.
